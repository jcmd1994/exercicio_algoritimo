...
let galoesTinta=Number (readlineSync.question ('Quantos galões será usado?'));

const calculoTinta=galoesTinta/0.25;
const calculoQuartos=galoesTinta*calculoTinta;


console.log("O valor de galões que será usado é:",calculoTinta,"galões,");
console.log("O valor de quartos que será usado é:",calculoQuartos,"quartos,");
